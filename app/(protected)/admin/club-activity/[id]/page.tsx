      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span>作成日: {formatDate(club.createdAt, "yyyy/MM/dd HH:mm")}</span>
          </div>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">最終更新日: {formatDate(club.updatedAt ?? new Date(), "yyyy/MM/dd HH:mm")}</p>
          </div>
        </CardContent>
      </Card>
    </div>
