...
export default function MemberListView({ members, onSelectMember }: MemberListViewProps) {
      ...
      {members.map((member, index) => {
        ...
        >
          <motion.div
            ...
            style={{
              borderColor: hoveredId === member.id ? memberColor : "transparent",
              boxShadow: hoveredId === member.id ? `0 0 15px ${memberColor}30` : "none",
            }}
            whileHover={{
              y: -5,
              ...
              {/* プロフィール画像 */}
                <div className="relative mr-4 flex-shrink-0">
                  <div
                    ...
                    style={{ borderColor: hoveredId === member.id ? memberColor : "transparent" }}
                  >
                    <motion.div
                    ...
                    {member?.skills?.map((skill, skillIndex) => (
                      <Badge
                        ...
                        style={{
                          ...
                          color: hoveredId === member.id ? memberColor : undefined,
                        }}
                      >
                        {skill}
                      </Badge>
